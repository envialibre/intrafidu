<?php
/**
 * Template Name: Escuela Principal
 * Description: Página principal de escuela
 *
 */
get_header();
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'content body-workspace' ); ?>>
			...
			<div class="row">
				<div class="col-md-12 p-4">
				   <span class="subtitulos">Cursos disponibles</span>
				</div>
			</div>				
			...
			<div class="row">
				...
				<?php
                    ...
                    $args = array(
                        'posts_per_page' => 4,
						'post_status' => 'publish',
                        'post_type' => 'cursos', // Set the post type to 'eventos'
					...
					<div class="row box-noti2 mb-4">
						...
						<div class="col-xs-6 col-md-6 box-otrasnoticias2 p-3 d-flex align-content-between flex-wrap">
                            ...
                            <div class="ver-mas pt-4 pb-2">
                                <a class="btn-naranja" target="_blank" href="<?php echo esc_html(get_the_permalink()); ?>">Evaluación</a>
                            </div>                            
						</div>
					</div>
                </div>
